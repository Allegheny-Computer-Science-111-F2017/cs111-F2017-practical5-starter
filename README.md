...
# cs111-F2017-practical5-starter

Designed for use with [GitHub Classroom](https://classroom.github.com/), this
repository contains the starter for Practical 5 in Computer Science 111. Since
...
sums their output. This program will construct instances of objects, call a
method provided by those objects, perform a computation, and then output the
result of the computation. Please see the comments in the source code and the
...
* The `RollAndSumDice` program must:
  ...
  * Construct three instances of the `Die` class
  * Declare and use an `int sum` variable
  * Call `println` four times to produce the desired output
...
```
./gatorgrader.sh --update git@github.com:Allegheny-Computer-Science-111-F2017/cs111-F2017-practical5-starter.git
```
...
Starter](https://github.com/Allegheny-Computer-Science-111-F2017/cs111-F2017-practical5-starter)
